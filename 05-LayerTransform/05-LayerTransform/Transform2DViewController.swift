...
class Transform2DViewController: UIViewController {
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        // Scale不仅能起到放大缩小的作用，当Scale传入的值为负的时候还能起到旋转的作用。当sx的值为负的时候，view会以Y轴为中心轴进行旋转180°，当sy为负时，图形会以X轴为中心轴进行旋转180°。当sx，sy都为负时，图形会顺时针旋转180°。由于Scale的正负可以影响view的旋转，所以当同事进行负值的变化和旋转时，两者会进行相互作用，产生各种神奇的效果。
